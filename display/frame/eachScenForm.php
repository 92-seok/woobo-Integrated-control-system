...
$dis_vo->Relay = '0';
$dis_vo->DisTime = '5';
$dis_vo->StrTime = date('Y-01-01 00:00:00');
$dis_vo->EndTime = date('Y-12-31 23:59:59', strtotime('+1 years'));
$dis_vo->HtmlData = '';
...
$viewType = '';
if (strpos($dis_vo->SendImg, 'video') !== false) {
    $viewType = 'video';
} elseif ($eqp_vo->ConnModel == 'EWDPL_LAN') {
    $viewType = 'image';
} elseif ($eqp_vo->ConnModel == 'EWDPL_C16') {
    $viewType = 'c16';
} elseif (strtolower($eqp_vo->ConnModel) == 'ewdisplay_lan') {
    $viewType = 'text';
}

$relay = preg_split('//', sprintf('%04d', decbin($dis_vo->Relay)), -1, PREG_SPLIT_NO_EMPTY);
        ...
        <div class="cs_displaybox">
            ...
            <div class="">
                <form method="post" name="eachScen" action="" id="id_form" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="cdDistObsv" id="cdDistObsv" value="<?= $cdDistObsv ?>">
                    ...
                    <div id="">
                        <h4 style="margin-top:20px;">◈ 개별 시나리오 설정</h4>
                        <table border="0" cellpadding="0" cellspacing="0" class="cs_datatable" rules="all">
                            ...
                            <tr id="trList1">
                                ...
                                <td width="34%">
                                    <select name="disEffect" id="disEffect">
                                        <option value="1" <?= $dis_vo->DisEffect == '1' ? 'selected' : '' ?>>즉시 표시
                                        </option>
                                        <option value="2" <?= $dis_vo->DisEffect == '2' ? 'selected' : '' ?>>좌측으로 스크롤
                                        </option>
                                        <option value="3" <?= $dis_vo->DisEffect == '3' ? 'selected' : '' ?>>위로 스크롤
                                        </option>
                                        <option value="4" <?= $dis_vo->DisEffect == '4' ? 'selected' : '' ?>>아래로 스크롤
                                        </option>
                                        <option value="5" <?= $dis_vo->DisEffect == '5' ? 'selected' : '' ?>>레이저 효과
                                        </option>
                                        <option value="6" <?= $dis_vo->DisEffect == '6' ? 'selected' : '' ?>>중심에서 상하로
                                            벌어짐</option>
                                        <option value="7" <?= $dis_vo->DisEffect == '7' ? 'selected' : '' ?>>상하에서 중심으로
                                            모여듬</option>
                                        <option value="8" <?= $dis_vo->DisEffect == '8' ? 'selected' : '' ?>>1단으로 좌측스크롤
                                        </option>
                                    </select>
                                </td>
                                <th width="16%">표시속도</th>
                                <td width="34%">
                                    <select name="disSpeed" id="disSpeed" style="width:45%;">
                                        <option value="1" <?= $dis_vo->DisSpeed == '1' ? 'selected' : '' ?>>1</option>
                                        <option value="2" <?= $dis_vo->DisSpeed == '2' ? 'selected' : '' ?>>2</option>
                                        <option value="3" <?= $dis_vo->DisSpeed == '3' ? 'selected' : '' ?>>3</option>
                                        <option value="4" <?= $dis_vo->DisSpeed == '4' ? 'selected' : '' ?>>4</option>
                                        <option value="5" <?= $dis_vo->DisSpeed == '5' ? 'selected' : '' ?>>5</option>
                                        <option value="6" <?= $dis_vo->DisSpeed == '6' ? 'selected' : '' ?>>6</option>
                                        <option value="7" <?= $dis_vo->DisSpeed == '7' ? 'selected' : '' ?>>7</option>
                                        <option value="8" <?= $dis_vo->DisSpeed == '8' ? 'selected' : '' ?>>8</option>
                                    </select>
                            ...
                            <tr id="trListHttp1">
                                <th width="16%">표시효과</th>
                                <td width="34%">
                                    <select name="disEffectHttp" id="disEffectHttp">
                                        <option value="0" <?= $dis_vo->DisEffect == '1' ? 'selected' : '' ?>>즉시 표시
                                        </option>
                                        <option value="1" <?= $dis_vo->DisEffect == '2' ? 'selected' : '' ?>>우에서 좌로 표시
                                        </option>
                                        <option value="2" <?= $dis_vo->DisEffect == '3' ? 'selected' : '' ?>>좌에서 우로 표시
                                        </option>
                                        <option value="3" <?= $dis_vo->DisEffect == '4' ? 'selected' : '' ?>>아래에서 위로 표시
                                        </option>
                                        <option value="4" <?= $dis_vo->DisEffect == '5' ? 'selected' : '' ?>>위에서 아래로 표시
                                        </option>
                                    </select>
                                </td>
                                <th width="16%">표시속도</th>
                                <td width="34%">
                                    <select name="disSpeedHttp" id="disSpeedHttp" style="width:45%;">
                                        <option value="1" <?= $dis_vo->DisSpeed == '1' ? 'selected' : '' ?>>1</option>
                                        <option value="2" <?= $dis_vo->DisSpeed == '2' ? 'selected' : '' ?>>2</option>
                                        <option value="3" <?= $dis_vo->DisSpeed == '3' ? 'selected' : '' ?>>3</option>
                                        <option value="4" <?= $dis_vo->DisSpeed == '4' ? 'selected' : '' ?>>4</option>
                            ...
                            <tr id="trList2">
                                ...
                                <td>
                                    <select name="endEffect" id="endEffect">
                                        <option value="1" <?= $dis_vo->EndEffect == '1' ? 'selected' : '' ?>>위로 스크롤
                                        </option>
                                        <option value="2" <?= $dis_vo->EndEffect == '2' ? 'selected' : '' ?>>아래로 스크롤
                                        </option>
                                        <option value="3" <?= $dis_vo->EndEffect == '3' ? 'selected' : '' ?>>위아래로 벌어짐
                                        </option>
                                        <option value="4" <?= $dis_vo->EndEffect == '4' ? 'selected' : '' ?>>중심으로 모여듬
                                        </option>
                                        <option value="5" <?= $dis_vo->EndEffect == '5' ? 'selected' : '' ?>>즉시 사라짐
                                        </option>
                                        <option value="6" <?= $dis_vo->EndEffect == '6' ? 'selected' : '' ?>>화면반전
                                        </option>
                                        <option value="7" <?= $dis_vo->EndEffect == '7' ? 'selected' : '' ?>>좌측으로 사라짐
                                        </option>
                                    </select>
                                </td>
                                <th>완료속도</th>
                                <td>
                                    <select name="endSpeed" id="endSpeed" style="width:45%;">
                                        <option value="1" <?= $dis_vo->EndSpeed == '1' ? 'selected' : '' ?>>1</option>
                                        <option value="2" <?= $dis_vo->EndSpeed == '2' ? 'selected' : '' ?>>2</option>
                                        <option value="3" <?= $dis_vo->EndSpeed == '3' ? 'selected' : '' ?>>3</option>
                                        <option value="4" <?= $dis_vo->EndSpeed == '4' ? 'selected' : '' ?>>4</option>
                                        <option value="5" <?= $dis_vo->EndSpeed == '5' ? 'selected' : '' ?>>5</option>
                                        <option value="6" <?= $dis_vo->EndSpeed == '6' ? 'selected' : '' ?>>6</option>
                                        <option value="7" <?= $dis_vo->EndSpeed == '7' ? 'selected' : '' ?>>7</option>
                                        <option value="8" <?= $dis_vo->EndSpeed == '8' ? 'selected' : '' ?>>8</option>
                                    </select>
                                    <div class="info" style="display: inline-block;">&nbsp;※ 1(빠름) ~ 8(느림)</div>
                                </td>
                            </tr>
                            <tr id="trListHttp2">
                                <th>완료효과</th>
                                <td>
                                    <select name="endEffectHttp" id="endEffectHttp">
                                        <option value="0" <?= $dis_vo->EndEffect == '1' ? 'selected' : '' ?>>즉시 없어짐
                                        </option>
                                        <option value="1" <?= $dis_vo->EndEffect == '2' ? 'selected' : '' ?>>우에서 좌로 없어짐
                                        </option>
                                        <option value="2" <?= $dis_vo->EndEffect == '3' ? 'selected' : '' ?>>좌에서 우로 없어짐
                                        </option>
                                        <option value="3" <?= $dis_vo->EndEffect == '4' ? 'selected' : '' ?>>아래에서 위로 없어짐
                                        </option>
                                        <option value="4" <?= $dis_vo->EndEffect == '5' ? 'selected' : '' ?>>위에서 아래로 없어짐
                                        </option>
                                    </select>
                                </td>
                                <th>완료속도</th>
                                <td>
                                    <select name="endSpeedHttp" id="endSpeedHttp" style="width:45%;">
                                        <option value="1" <?= $dis_vo->EndSpeed == '1' ? 'selected' : '' ?>>1</option>
                                        <option value="2" <?= $dis_vo->EndSpeed == '2' ? 'selected' : '' ?>>2</option>
                                        <option value="3" <?= $dis_vo->EndSpeed == '3' ? 'selected' : '' ?>>3</option>
                                        <option value="4" <?= $dis_vo->EndSpeed == '4' ? 'selected' : '' ?>>4</option>
                            ...
                            <tr id="trListHttp3">
                                <th>표시유지시간</th>
                                <td>
                                    <select name="disTimeHttp" id="disTimeHttp" style="width:20%;">
                                        <?php for ($i = 1; $i <= 20; $i++) {
                            ...
                            <tr id="trList3">
                                ...
                                <td>
                                    <div class="cs_container" style="font-size: 13px;">
                                        <div>1번</div>
                                        <input type="checkbox" class="cs_relay" value="8"
                                            style="margin-right: 25px;zoom: 1.2;"
                                            <?= $relay[0] == '1' ? 'checked' : '' ?>>
                                        <div>2번</div>
                                        <input type="checkbox" class="cs_relay" value="4"
                                            style="margin-right: 25px;zoom: 1.2;"
                                            <?= $relay[1] == '1' ? 'checked' : '' ?>>
                                        <div>3번</div>
                                        <input type="checkbox" class="cs_relay" value="2"
                                            style="margin-right: 25px;zoom: 1.2;"
                                            <?= $relay[2] == '1' ? 'checked' : '' ?>>
                                        <div>4번</div>
                    ...
                    <div class="" id="container">
                        ...
                        <table id="id_ment" border="0" cellpadding="0" cellspacing="0" class="cs_datatable" rules="all">
                            <tbody>
                                <tr>
                                    ...
                                    <th width="16%">멘트종류</th>
                                    <td width="32%">
                                        <select name="mentList" id="mentList" style="width: 70%; text-indent:0px;">
                        ...
                        <div id="image2" style="float: left; padding: 15px;">
                            ...
                            <div
                                style="float: left; border: 5px solid red; width: <?= $sizeX ?>px; height: <?= $sizeY ?>px; padding: 0px;">
                        ...
                        <div id="text">
                            ...
                            <div class="addMent">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="displayTable"
                                    id="displayAddTable" rules="all">
                                    <tr>
                                        <td>
                                            <input type="text" class="displayMentInput" id="addText" value=""
                                                maxlength="30">
                                        </td>
                                        <td>
                                            <div id="id_addMentBtn" class="addMentBtn" data-x="<?= $sizeX ?>"
                                                data-y="<?= $sizeY ?>">+ 전광판 내용 입력</div>
                                        </td>
                                    </tr>
                                </table>
            ...
            <div class="cs_btnBox">
                <div class="cs_btn" name="id_savScen" id="id_savScen" data-page="<?= $page ?>"
                    style="float:none; margin-top: 25px;">전광판 이미지 업로드</div>
            </div>
...
$(document).ready(function(e) {
    ...
    console.log("ready eachScenForm");
    ...
    $('#id_summernote').summernote({
        ...
        fontSizes: ['18', '24', '36', '38', '40', '42', '44', '46', '48', '52', '56', '72'],
        lineHeights: ['1.0', '1.1', '1.2', '1.3', '1.5', '2.0'],
        callbacks: {
            onInit: function() {
    ...
    $("#id_summernote").summernote('lineHeight', 1.1);
    ...
    console.log("mount eachScenForm");
});
...
function selectBox(type, viewType) {
    ...
    let trHttp1 = document.querySelector("#trListHttp1");
    let trHttp2 = document.querySelector("#trListHttp2");
    let trHttp3 = document.querySelector("#trListHttp3");
    ...
    trHttp1.style.display = "none";
    trHttp2.style.display = "none";
    trHttp3.style.display = "none";
    ...
    switch (viewType) {
        ...
        case "c16":
            if (kind.value === "image") {
                ...
                tr0.style.display = "table-row";
                trHttp1.style.display = "table-row";
                trHttp2.style.display = "table-row";
                trHttp3.style.display = "table-row";
                tr4.style.display = "table-row";
...
function validImageType(image) {
    ...
    return (['video/mp4', 'video/x-ms-wmv', 'video/avi', 'video/mov', 'video/mkv', 'video/flv', 'video/ogg',
        'video/webm', 'video/ogv'
